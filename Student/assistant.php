...
<div class="hide_desc">Chat with Ana.</div>

<div class="assistant_panel" id="assistant_panel">
    <div class="pane_header" onclick="hideAssistant()">Ana Assistant</div>
    <div class="">
        <span class="head_assistant"><img src="../assets/Images/assistant.png" alt=""> &nbsp; Ana</span>
        <p class="conversation_assistant">Hi, I'm your assistant Ana, how can I help you?</p>
    </div>
